...
async def _application_response(db: AsyncSession, application: Application) -> ApplicationResponse:
    ...
    return ApplicationResponse(
        ...
        material_terms_snapshot=dict(application.material_terms_snapshot),
        acknowledgment_snapshot=dict(application.acknowledgment_snapshot),
        packet_digest=application.packet_digest,
