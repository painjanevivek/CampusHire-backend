...
| Pilot go/no-go | release dossier | Named final authority | Vivek Painjane (Admin) | Approved with prerequisites on 2026-08-24 | Effective only after staging, recovery, UAT, governance reviews, and deferred security scans pass | [Release candidate dossier](RELEASE_CANDIDATE_DOSSIER_2026-08-24.md) |
