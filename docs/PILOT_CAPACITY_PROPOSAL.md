...
| Availability objective | 99.5% monthly, excluding announced maintenance |
...
Approval must identify the rate-card source/date, retention multiplier, taxes/egress, monitoring, backups, headroom, and owner for quota alerts.
