...
| NFR security and privacy | auth/CSRF/CORS/upload/tenant tests, dependency checks, deletion tests, threat model | CSP/API-destination tests, dependency audit | Deep Scans explicitly deferred (not passed); parser isolation and cross-boundary staging review remain |
