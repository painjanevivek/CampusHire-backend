...
| Candidate freeze and launch | release-manifest generator, no-go dossier, deployment/rollback runbook, controlled launch record | frontend candidate SHA and browser/accessibility evidence | clean immutable repositories, image/config/migration/rollback artifacts, staging access, named go/no-go, and monitored deployment |
