...
CONFIGURATION_PATHS: Final = (
    ...
    ("backend", ".github/workflows/deploy-shared-vm-staging.yml"),
    ("backend", "Dockerfile"),
    ...
    ("backend", "deploy/shared-vm/Caddyfile.site"),
    ("backend", "deploy/shared-vm/compose.override.yaml"),
    ("backend", "deploy/shared-vm/deploy.sh"),
